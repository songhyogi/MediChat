...
public class XUtil {
	public static Response getDetailList(HttpServletRequest request,String category) throws JAXBException,IOException{
	...
	public static Response getDiseaseDepart(HttpServletRequest request,String category) throws JAXBException,IOException{

		String serviceKey = "bBcw2bsbnZbe4NBgjrT8%2BVhedqNa8T3RaUHbuxCtnu4X6kiDo4KVAyGMWXZRwklSJba6SMoFiKmJwzYUcex6Gw%3D%3D"; //키 발급시 0, 캡챠 이미지 비교시 1로 세팅
		String vcnCd = category;
		String key_apiURL = "https://apis.data.go.kr/B551182/diseaseInfoService/getDissNameCodeList?sickType=1&medTp=1&numOfRows=100&ServiceKey=" + serviceKey;
