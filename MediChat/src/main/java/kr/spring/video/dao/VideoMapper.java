...
public interface VideoMapper {
	...
	@Update("UPDATE video_healthy SET video_title=#{video_title}, video_content=#{video_content},video_category=#{video_category},v_modify_date=sysdate WHERE video_num=#{video_num}")
	...
	//조회수
	@Update("UPDATE video_healthy SET hit=hit+1 WHERE video_num=#{video_num}")
