...
<div class="page-main">
	<div class="page-one">
     ...
     <span class=" fs-12 fw-4 text-black-3">본 답변은 의학적 판단이나 진료 행위로 해석 될 수 없으며, 메디챗은 이로 인해 발생하는 어떠한 책임도 지지 않습니다.<br>
     정확한 개인 증상 파악 및 진단은 의료 기관 내방을 통해 진행하시기 바랍니다.<br>
     고객님의 개인정보 보호를 위해 개인정보는 기재하지 않습니다.<br>
     서비스에 입력되는 데이터는 내부 정책에 따라 관리됩니다.</span><br><br><br>
