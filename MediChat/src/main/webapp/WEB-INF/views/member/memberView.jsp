		...
		<div class="basic">
			...
			<div class="border p-5">
				...
				<div class="row mt-5">
					...
					<div class="col-4 d-flex justify-content-center align-items-center"><input type="button" value="0" onclick="location.href='${pageContext.request.contextPath}/reservation/myResList'"></div>
					<div class="col-4 d-flex justify-content-center align-items-center"><input type="button" value="0" onclick="location.href='#'"></div>
				</div>
			</div>
			<ul>
